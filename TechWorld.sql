...
--
-- Host: localhost:8889
-- Generation Time: Feb 27, 2023 at 06:14 AM
...
CREATE TABLE `items` (
  ...
  `image_name1` varchar(20) NOT NULL,
  `image_name2` varchar(20) NOT NULL,
  `image_name3` varchar(20) NOT NULL,
  `image_name4` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `items` (`item_id`, `item_name`, `category`, `brand`, `item_price`, `img_name1`, `img_name2`, `img_name3`, `img_name4`, `long_description`, `image_name1`, `image_name2`, `image_name3`, `image_name4`) VALUES
...
(1, 0, 'asd ASD,SDASD', 'asd ASD,SDASD', 'Badulla', 'asdsd', 'Sanjeewa', '032', '$2a$10$HRcalv4Q206wXHJh/rxF..EAVX.QkhZ7OxfI2wCzuIe.F7mjPC.au', '12312', 'uva', 'Basnayaka'),
(2, 0, 'No 40, wewa kotasa, puhulwatta', 'maussagolla,passara', 'Badulla', 'hiransanjeewaa@gmail.com', 'Hiran Sanjeewa', '0702568106', '$2a$10$KNiy.eRr203VjWUZYecM5Olt1zHVxQOlTqSYuVXSbls6KBMHeP39W', '12312', 'uva', 'Basnayaka'),
(52, 0, 'No 40, wewa kotasa, puhulwatta', 'maussagolla,passara', 'Badulla', 'hiransanjeewa@gmail.com', 'Hiran Sanjeewa', '070268106', '$2a$10$kZHKZ9OcosZ4GuaotN9UQ.AkmCaTT8ZlwnD.UwXRhtmXNg5UcdNlu', '12312', 'uva', 'Basnayaka');
