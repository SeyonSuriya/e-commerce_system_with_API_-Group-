...
--
-- Host: localhost:8889
-- Generation Time: Apr 08, 2023 at 07:08 AM
...
(4, 'Swarna Gurusinghe', 3, 'THEORY OF MUSIC ', 'Music', '9790900644824', 'Having covered basic theory in the first two volumes, the third tackles more complex issues such as chord structures and compound time, chapters that act as a revision for work from earlier grades, as well as the topics required to sit the ABRSM Grade 3 Theory Exam. Contents: Demisemiquaver;', 3, 35, 'Swarna Gurusinghe', 0),
(5, 'Devar Surya Sena', 7, 'MUSIC OF SRI LANKA', 'Music', '9789556650099', 'Major Keys With Four Sharps Or Flats; Tonic Triads; Beyond 2 Ledger Lines; Transposition; Compound Time (6/8, 9/8, 12/8); Rules of Compound Time; Minor Keys with Four Sharps Or Flats; Grouping Notes And Rests In Compound Time; Scales And Key Signature (Revision); Four-Bar Rhythm; Intervals; Simple Phrase Structure; Performance Directions; General Exercises; Revision.', 5, 40, 'Vijitha Yapa Publications', 1),
...
(7, 'Maya Abeywickrama', 4, 'REMINISCENCES OF A MUSIC', 'Music', '9789556653328', 'In this book Dr. Maya Abeywickrama, a highly qualified consultant in Western Music demonstrates clearly and authoritatively the pervasive beneficent influence Western music has had on the Music of Sri Lanka ever since the Portuguese invaded Sri Lanka some 500 years ago.\r\n', 4, 45, 'VIJITHA YAPA PUBLICATIONS', 0),
...
--
ALTER TABLE `wishlist`
  MODIFY `wishno` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
